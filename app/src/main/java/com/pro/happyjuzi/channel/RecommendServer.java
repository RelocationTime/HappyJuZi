...
public interface RecommendServer {
    ...
    @GET("article/list/author?page=1&ts=0&mac=68-3e-34-80-6d-8b&uid=4029527336798670&pf=android&net=wifi&accesstoken=82ff5a67a57d104572e7c38c803dbf95&channel=qihoo360&ver=3.4&res=1080x1920")
    Call<AuthorBeanInfo> getRecommendAuthor(@Query("id") int id);
