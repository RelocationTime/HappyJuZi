...
import com.pro.happyjuzi.bean.Student;
...
public class StudentDao extends AbstractDao<Student, Void> {
    ...
    public static class Properties {
        public final static Property Password = new Property(0, String.class, "password", false, "PASSWORD");
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0) // password
        );
        return entity;
    }
